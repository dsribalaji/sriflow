...
// trim: domain-skill-commands, browser-skill-commands removed for sriflow (solo use)
import { validateNavigationUrl } from './url-validation';
// trim: token-registry removed for sriflow (no scoped tokens)
...
export async function handleMetaCommand(
  ...
  switch (command) {
    ...
    case 'tab-each': {
      ...
      // trim: scope check removed for sriflow (solo use, no auth tokens)
    ...
    // trim: domain-skill, skill commands removed for sriflow (solo use)
