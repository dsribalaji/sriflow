...
## Architecture Notes
<Technical decisions, components, data flow — 3-5 bullet points>
- Runtime / language / framework decision and why
- Key external dependencies or APIs
- Data storage approach (files, DB, in-memory)
- Deployment or distribution model (standalone binary, npm package, etc.)

## Constraints & Risks
<Things that could block or delay — 2-3 bullet points>
...
## Prerequisites for Next Skill (/sriflow-plan)
- THINK_OUTPUT.md written ✓
- No formal Stakeholder Register (Small tier — plan will derive one)
- Plan skill: will auto-generate a minimal stakeholder list from this doc
